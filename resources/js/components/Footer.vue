...
<li>
<a href="#" class="mr-4 hover:underline md:mr-6  hover:text-greenprimary ">Tentang Kami</a>
</li>
<li>
<a href="https://www.instagram.com/nyehaat.id/" class="mr-4 hover:underline md:mr-6 hover:text-greenprimary">Sosial Media</a>
</li>
<!-- <li>
...
<span class="block text-sm text-gray-500 sm:text-center font-opensans dark:text-gray-400">© 2022 <a href="https://flowbite.com" class="hover:underline">Nyehaat.id</a>. Surabaya,Indonesia
</span>
</footer>
